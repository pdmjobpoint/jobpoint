...
class EligibilitySearch extends Eligibility
{
    ...
    public function rules()
    {
        return [
            [['id'], 'integer'],
            [['eligibility_code', 'eligibility_name'], 'safe'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere(['like', 'eligibility_code', $this->eligibility_code])
            ->andFilterWhere(['like', 'eligibility_name', $this->eligibility_name]);
